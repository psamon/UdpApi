...
import com.anz.UdpApi.transform.pojo.Result;
 ...
 * 
 */
public class UdpApiFlowFailureTest extends FlowTest {
	...
	private static final String TEST_FILE_001 = "UdpApi.FailTest001.xml";
	private static final String applicationName = "UdpApi-app";
	...
	public void injectData() throws IOException, ConfigManagerProxyPropertyNotInitializedException, ConfigManagerProxyLoggedException {
		...
		String message = IOUtils.toString(UdpApiFlowTest.class.getResourceAsStream(TEST_FILE_001));
		//String jsonBlob = TransformUtils.getBlob(message);
		String messageFormat = IOUtils.toString(UdpApiFlowTest.class.getResourceAsStream(MESSAGE_FORMAT));
